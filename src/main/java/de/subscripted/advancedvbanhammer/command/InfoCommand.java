...
public class InfoCommand extends Command implements TabExecutor {
    ...
    public void execute(CommandSender sender, String[] args) {
        ...
        if (args.length < 1) {
            ...
            player.sendMessage(TextComponent.fromLegacyText("§x§f§b§1§c§1§5§lP§x§f§b§4§3§1§4§lr§x§f§c§6§a§1§3§le§x§f§c§9§0§1§2§lf§x§f§d§b§7§1§1§li§x§f§d§d§e§1§0§lx §8§l· §7" + BungeeBan.getInstance().getPrefix()));
        ...
        if (args.length == 1) {
            ...
            FileManager.reloadPrefix(BungeeBan.getInstance());
            sender.sendMessage(TextComponent.fromLegacyText(BungeeBan.getInstance().getPrefix() + FileManager.getMessage(ConfigMessage.RELOAD_SUCCESS)));
        }
    }
